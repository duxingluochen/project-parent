...
import com.mapscience.ProjectAdminApplication;
...
public class DefaultTemplateFactory {
    ...
    public static CodeProperties getDefaultParams(){
        ...
        codeProperties.setProjectPath(ToolUtil.getWebRootPath("project-core"));
        //codeProperties.setProjectPath(CoreFlag.class.getPackage().getName());
        codeProperties.setAuthor("wty");
        codeProperties.setProjectPackage(ProjectAdminApplication.class.getPackage().getName());

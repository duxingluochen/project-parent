...
public class ConstantFactory implements IConstantFactory {
    ...
    private DriverMapper DriverMapper = SpringContextHolder.getBean(DriverMapper.class);
    private NoticeMapper noticeMapper = SpringContextHolder.getBean(NoticeMapper.class);
    private PortflowMapper portflowMapper = SpringContextHolder.getBean(PortflowMapper.class);
    ...
    public String getMenuNames(String menuIds) {
        ...
        for (int menu : menus) {
            ...
            if (ToolUtil.isNotEmpty(menuObj) && ToolUtil.isNotEmpty(menuObj.getMenuName())) {
                sb.append(menuObj.getMenuName()).append(",");
            }
        }
        return StrKit.removeSuffix(sb.toString(), ",");
    }
    ...
    @Override
    public String getDriverName(String driId) {
        Driver driver=DriverMapper.selectById(driId);
        if (driver != null) {
            return getUserNameById(driver.getUserId());
        } else {
            return "--";
        }
    }
    ...
    @Override
    public List<Map<String, Object>> getFlowNodeSchedule(String eventId) {
        return portflowMapper.selectFlowNodeSchedule(eventId);
    }
}

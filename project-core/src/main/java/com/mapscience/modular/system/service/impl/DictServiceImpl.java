...
import com.mapscience.modular.system.mapper.DictMapper;
...
import static com.mapscience.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictCode,String dictName,String dictTips, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new ProjectException(ProjectStatusEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new ProjectException(ProjectStatusEnum.DICT_MUST_BE_NUMBER);
            }
    ...
    @Override
    public List<Map<String, Object>> list(Page<Dict> page, String conditiion) {
        return this.baseMapper.list(page,conditiion);
    }

    @Override
    public List<ZTreeNode> selectTreeListByParentCode(String code) {
        return this.baseMapper.selectTreeListByParentCode(code);
    }
}

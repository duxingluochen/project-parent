...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        packageConfig.setEntity(codeProperties.getProjectPackage() + ".modular."+codeProperties.getModuleName()+".model");
        packageConfig.setMapper(codeProperties.getProjectPackage() + ".modular."+codeProperties.getModuleName()+".mapper");
        packageConfig.setXml(codeProperties.getProjectPackage() + ".modular."+codeProperties.getModuleName()+".mapper.mappers");
